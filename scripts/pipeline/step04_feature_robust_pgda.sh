...
# Step 04: Feature-robust PGDA training and degradation benchmark
#
# Input gates:
...
#
# Outputs:
#   data/processed/feature_robust_results_step04.csv
#   reports/benchmarks/step04_feature_robust_pgda.md
#   reports/benchmarks/step04_feature_robust_pgda.json
#   .pipeline_state/step04_feature_robust_pgda.PASS
#
# Run:
#   bash step04_feature_robust_pgda.sh
# or:
#   PROJECT_DIR=/path/to/robust-ofi-lobster bash step04_feature_robust_pgda.sh
...
if [[ ! -f ".pipeline_state/step03_graph_baseline.PASS" ]]; then
  echo "[ERROR] Step 03 gate missing: .pipeline_state/step03_graph_baseline.PASS"
  echo "        Run Step 03 first and verify its benchmark PASS."
  exit 1
fi
...
cat > src/lobster_ofi/step04_feature_robust_pgda.py <<'PY'
...
python src/lobster_ofi/step04_feature_robust_pgda.py

echo
echo "[DONE] Step 04 report:"
echo "  ${PROJECT_DIR}/reports/benchmarks/step04_feature_robust_pgda.md"
